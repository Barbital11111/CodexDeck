...
type ClassicRouterLaunchCardProps = {
...
export function ClassicRouterLaunchCard({
  accounts,
  switchingId,
  hideAccountDetails,
  settings,
  ...
  return (
    <>
      <article
        className={`accountCard routerLaunchCard tone-api ${
          settings.modelRouterEnabled ? "isCurrent" : ""
        } ${routerModeBusy || launchBusy ? "isSwitching" : ""}`}
      >
          ...
          <div className="accountMetaRow">
            ...
            <div className="accountMetaValue accountTagSummary">
              {previewModelNames.length > 0 ? (
                ...
                <span className="accountMetaEmpty">未选择模型</span>
              )}
            </div>
          </div>
        </div>
