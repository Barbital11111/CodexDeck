...
export function ClassicAddAccountDialog({
  open,
  reauthorizeAccount,
  importingAccounts,
          ...
          <div className="addAccountPanel">
            ...
            {activeRoute === "api" ? (
              <div className="addAccountPanelBody addApiSection">
                ...
                <section className="addApiQuotaPanel">
                  <label className="addApiQuotaToggle">
                    <span>
                      <strong>{copy.addAccount.apiQuotaToggleLabel}</strong>
                      <small>{copy.addAccount.apiQuotaToggleHint}</small>
                    </span>
                    <input
                      type="checkbox"
                  ...
                  {apiForm.balanceDisplayEnabled ? (
                    <div className="addApiQuotaUnlocked">
                      <div className="addApiQuotaNote">
                        <strong>{copy.addAccount.apiQuotaTokenTitle}</strong>
                      ...
                      <div className="addApiFieldGrid">
                        ...
                        <label className="addOauthField">
                          <span className="addOauthFieldLabel">
                            {copy.addAccount.apiPlatformPasswordLabel}
                          </span>
                          <input
                            className="addOauthInput"
                            type="password"
                      ...
                      <p className="addFieldHint">{copy.addAccount.apiPlatformSyncHint}</p>
                    </div>
                  ) : null}
                </section>
