...
type HybridLaunchPanelProps = {
  ...
  onSwitchHybrid: (chatgptAccount: AccountSummary, relayAccount: AccountSummary) => void;
};
...
export function ClassicHybridLaunchPanel({
  accounts,
  switchingId,
  hideAccountDetails,
  onSwitchHybrid,
  ...
  return (
    <section className="hybridLaunchPanel" aria-label={copy.addAccount.hybridTitle}>
