...
Function PageReinstall
  ...
  ${Else}
    ReadRegStr $R0 SHCTX "$PreviousUninstKey" "DisplayVersion"
  ${EndIf}
  ...
  ; Default to in-place installation for standard NSIS upgrades/reinstalls.
  ; Keep the explicit choice page only when migrating from a WiX install,
  ; or when downgrades require uninstalling first.
  ${If} $WixMode <> 1
